...
// 프로미스를 기다렸다가 결과를 dispatch 하는 Saga Module
...
/**
 * @param type 액션의 타입
 * @param key 상태의 key (예: posts, post)
 * @param keepData 해당 값이 true로 주어 진다면 로딩을 하는 경우에도 데이터를 유지한다.
 * @returns 비동기 관련 액션들을 처리하는 리듀서를 반환
 */
